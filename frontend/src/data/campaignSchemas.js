...
export const SESSION_SCHEMA = {
    ...
    fields: [
        ...
        { key: 'title', label: 'Título', type: 'text', placeholder: 'Ej. La caída del puente', col: 'full' },
        ...
        { key: 'xp_awarded', label: 'XP otorgada', type: 'number', min: 0, col: 'third' },
...
export const QUEST_SCHEMA = {
    ...
    fields: [
        ...
        { key: 'status', label: 'Estado', type: 'select', options: QUEST_STATUS_OPTIONS, col: 'half' },
        { key: 'type', label: 'Tipo', type: 'select', options: QUEST_TYPE_OPTIONS, col: 'half' },
...
export const NPC_SCHEMA = {
    ...
    fields: [
        ...
        { key: 'disposition', label: 'Disposición', type: 'select', options: DISPOSITION_OPTIONS, col: 'half' },
        { key: 'status', label: 'Estado', type: 'select', options: STATUS_NPC_OPTIONS, col: 'half' },
...
export const LOCATION_SCHEMA = {
    ...
    fields: [
        { key: 'name', label: 'Nombre', type: 'text', required: true, col: 'full' },
        { key: 'type', label: 'Tipo', type: 'select', options: LOCATION_TYPE_OPTIONS, col: 'half' },
        ...
        { key: 'discovered', label: 'Descubierto por el grupo', type: 'checkbox' },
        { key: 'dm_notes', label: 'Notas privadas DM', type: 'textarea', rows: 3, dmOnly: true },
    ],
}
...
export const FACTION_SCHEMA = {
    ...
    fields: [
        ...
        { key: 'party_reputation', label: 'Reputación grupo (-100 a 100)', type: 'number', min: -100, max: 100, col: 'half' },
